...
def create_steering_messages(packer, CP, CAN, enabled, lat_active, apply_torque, lkas_icon, v_ego=0.):
  common_values = {
    "LKA_MODE": 2,
    "LKA_ICON": lkas_icon,
    ...
    "NEW_SIGNAL_2": 0,
    "DAMP_FACTOR": int(np.interp(v_ego, [0, 10, 23, 35, 50], [50, 100, 131, 148, 160])),
  }
